   ...
   return (
      ...
      >
         <Flex flexGrow={1} direction="column" gap="md">
            ...
            <Box>
               <Heading paddingBottom={4} size="sm">Notes</Heading>
               <Text>IP network ranges must fall on a natural subnet boundary.</Text>
               <Text>Blank lines and lines starting with a hash character are ignored.</Text>
               <Text>
                  An <Code>exclude</Code> range will override the corresponding{' '}
                  <Code>include</Code> range (if both are present).
               </Text>
            </Box>
            <Box>
               <Heading paddingBottom={4} size="sm">Warnings</Heading>
               <Text>
                  Do not include massively large network ranges (eg. <Code>0.0.0.0/0</Code>)
               </Text>
            </Box>
         </Flex>
      </SSModal>
