        ...
        <Modal isOpen={isOpen} onClose={onClose} isCentered>
            ...
            <ModalContent minW={{ base: 'md', lg: '3xl' }} maxW={{ base: 'md', lg: '3xl' }}>
                <ModalHeader textTransform={'capitalize'}>
                    {selectedCount === 1
                        ? `Assign Poller to - ${row?.name}`
                        : `Assign Pollers to ${selectedCount} Devices`}
                </ModalHeader>
                <ModalCloseButton onClick={onClose} isDisabled={isSubmitting} />
                <ModalBody>
                                        ...
                                        <Flex {...PollerProps}>
                                            ...
                                            <Box width={'200px'}>
                                                <Controller
                                                    ...
                                                    control={control}
                                                    rules={{
                                                        required: 'At least one ping poller is required',
                                                        validate: (value) =>
                                                            (value && value.length > 0) || 'At least one ping poller is required'
                                                    }}
                                                    render={({ field, fieldState }) => (
                                                        <EntityTypeAhead
                                                            isMulti={true}
